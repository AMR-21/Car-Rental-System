...
('0824f973fe', 'bentley', 'continental-gt', 'hatchback', 'white', 2022, 4, 'fuel', 'automatic', 2500, 'reserved', '149dc', 'Germany'),
...
('1dd55b7ee3', 'bentley', 'continental-gt', 'hatchback', 'black', 2022, 4, 'fuel', 'automatic', 2500, 'reserved', '84dd5', 'France'),
...
('00b94dd08b', 'maiara.novaes@example.com', '4f7f358cd341d703b4a502b2d0f53db07823b501', '(93) 4922-2826', 'Maiara', 'Novaes', 'DA8C34', 'Brazil'),
('021457c1dc', 'charlie.lam@example.com', '3fbd038e09141b4ecd846fb94709fff0758b1257', 'N69 S04-9047', 'Charlie', 'Lam', '146594', 'Canada'),
...
('2022-12-21', '0824f973fe', 'rented'),
('2022-12-27', '050fa71fa7', 'active'),
...
('8b909a5f03', '43831f79ac', '00b94dd08b', '2022-12-27', 'cash', 'paid', 7950, '2022-12-27', 9);
...
--
ALTER TABLE `favourites`
  ADD CONSTRAINT `favourites_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`),
...
--
ALTER TABLE `history`
  ADD CONSTRAINT `history_ibfk_1` FOREIGN KEY (`car_id`) REFERENCES `car` (`car_id`);

--
-- Constraints for table `payments`
--
ALTER TABLE `payments`
  ADD CONSTRAINT `payments_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `reservations` (`customer_id`),
  ADD CONSTRAINT `payments_ibfk_2` FOREIGN KEY (`car_id`) REFERENCES `reservations` (`car_id`),
  ADD CONSTRAINT `payments_ibfk_3` FOREIGN KEY (`res_id`) REFERENCES `reservations` (`res_id`);

--
-- Constraints for table `reservations`
--
ALTER TABLE `reservations`
  ADD CONSTRAINT `reservations_ibfk_1` FOREIGN KEY (`car_id`) REFERENCES `car` (`car_id`),
  ADD CONSTRAINT `reservations_ibfk_2` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`);
COMMIT;
